...
class PayKakao extends JFrame implements ActionListener {
...
//        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            String s = null;
            boolean isOk = false;
            BufferedWriter bw = new BufferedWriter(new FileWriter("kakaopw.txt", true));
            BufferedReader br = new BufferedReader(new FileReader("kakaopw.txt"));
